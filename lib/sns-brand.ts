...
export const FEATURES: Feature[] = [
  {
    ...
    body: [
      ...
      "해그로시는 브랜드의 타겟을 크게 4종류로 나눠 우선순위의 고객층을 목표로 연간 동시 시청자 수 확보를 목표로 5개의 채널을 운영했습니다.",
      "그리고 지난 부정적 댓글들은 '이런 컨텐츠 계속 해달라는' 팬들의 응원으로 바뀌고, 롱폼 시리즈와 함께 수많은 숏폼 부스팅으로 컨텐츠 가설을 검증하고 점진적인 지표 성과를 높일 수 있었습니다.",
    ],
    stats: [
      { v: "공식 SNS 채널 통합 운영" },
      { v: "유튜브 총 300편 기획제작" },
  ...
  },
  {
    ...
    body: [
      "문제를 공감하고 전문적으로 해결해주는 카운셀러들을 유튜브는 애정합니다. 연애상담 브랜드의 상담사들을 특정 주제별 캐릭터 있는 선생님으로 변신시키고 이들에게 연애 문제의 해결책을 받고 싶은 시청자들을 고객으로 유치했습니다.",
      "광고비 한 푼 없이 유튜브 팀과 채널 하나를 잘 셋업하니 신규 브랜드 매출이 6개월내 2억 이상을 돌파하고, 결제 전환되는 DB량이 폭발적으로 성장합니다.",
    ],
    stats: [
  ...
  },
  {
    ...
    body: [
      "퍼포먼스마케팅으로 옷장 정리 Before/After 컷을 열심히 광고 돌리지만 결국 CAC(고객 한명당 유치비용) 이슈로 ROI 개선이 필요했던 스타트업입니다.",
      "브랜드 내부 고객과 직원을 통해 30-40평대 아파트부터 빌라 투룸, 원룸까지 사연자들의 집을 다니며 옷장 정리의 마법을 보여줍니다.",
      "그리고 퍼포먼스마케팅 광고 소재로 Multi-Use하며 CAC를 대폭 개선합니다.",
    ],
    stats: [
      { v: "CAC 17%P 개선" },
      { v: "첫 영상부터 알고리즘 대박" },
  ...
  },
  {
    ...
    body: [
      ...
      "실제 사연 있는 강아지 친구들과 보호자들을 섭외해 인터뷰 에피소드와 함께 생식 등의 펫푸드 요리 과정을 선보입니다.",
      "결국 처방식 고급 라인 사료 및 컨설팅 영역까지 연결하는 큰 그림을 만듭니다.",
    ],
    stats: [
      { v: "SNS 채널 통합 브랜딩" },
      { v: "댕터뷰-블라인드 시식대회" },
...
export const PORTFOLIO = {
  ...
  shots: [
    ...
    },
    {
      ...
      alt: "페르소나별로 갈라 편성한 컨텐츠 라인업",
    },
    { src: "/sns/yeolda-shoot.jpg", alt: "브랜드 채널 촬영 현장" },
    { src: "/sns/trusty-product.jpg", alt: "펫푸드 커머스 브랜드 컨텐츠" },
  ],
} as const;
